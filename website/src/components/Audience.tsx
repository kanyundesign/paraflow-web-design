...
import { Rocket, Building2, Target, Brain, Code, Lightbulb } from "lucide-react";
...
function AudienceCard({ icon, title, description, index }: AudienceCardProps) {
  ...
  return (
    ...
    >
      <div className="relative h-full bg-gradient-to-br from-white/[0.03] to-transparent border border-white/40 rounded-2xl p-6 hover:border-paraflow-green hover:bg-white/[0.04] transition-all duration-500 cursor-pointer overflow-hidden">
        {/* 背景光效 */}
        ...
        {/* 图标 */}
        <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/20 flex items-center justify-center mb-5 group-hover:scale-110 group-hover:bg-paraflow-green/15 group-hover:border-paraflow-green/30 transition-all duration-500">
          {icon}
        </div>
...
export default function Audience() {
  ...
  const audiences: Omit<AudienceCardProps, "index">[] = [
    {
      icon: <Rocket className="w-5 h-5 text-white group-hover:text-paraflow-green transition-colors duration-300" />,
      title: "Startup",
      description: "Ship your MVP in days, not months. Iterate on your AI logic and UI interface simultaneously on one canvas.",
    },
    {
      icon: <Building2 className="w-5 h-5 text-white group-hover:text-paraflow-green transition-colors duration-300" />,
    ...
    {
      icon: <Target className="w-5 h-5 text-white group-hover:text-paraflow-green transition-colors duration-300" />,
      title: "PM",
    ...
    {
      icon: <Brain className="w-5 h-5 text-white group-hover:text-paraflow-green transition-colors duration-300" />,
    ...
    {
      icon: <Code className="w-5 h-5 text-white group-hover:text-paraflow-green transition-colors duration-300" />,
      title: "Engineer",
      description: "Skip the boilerplate setup. Get clean, modular code generated by the agent and focus on complex backend logic.",
    },
    {
      icon: <Lightbulb className="w-5 h-5 text-white group-hover:text-paraflow-green transition-colors duration-300" />,
